...
extension UIStepper: DefaultSignalProvider {
	public var defaultSignal: Signal<Double, NoError> {
...
extension UISlider: DefaultSignalProvider {
	public var defaultSignal: Signal<Float, NoError> {
		return reactive.values
	}
}
